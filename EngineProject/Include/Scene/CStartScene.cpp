...
bool CStartScene::Init()
{
	...
	pRectCollider->AddCollisionFunction(CS_ENTER, pStartButton, &CUIButton::MouseOn);
	pRectCollider->AddCollisionFunction(CS_LEAVE, pStartButton, &CUIButton::MouseOut);
	...
	pEndButton->SetPos(GET_RESOLUTION.nWidth / 2 - 100, GET_RESOLUTION.nHeight / 2 - 150);
