...
bool CUIButton::Init()
{
    CRectCollider* pCol = AddCollider<CRectCollider>("ButtonBody");
    pCol->AddCollisionFunction(CS_ENTER, this, &CUIButton::MouseOn);
    pCol->AddCollisionFunction(CS_LEAVE, this, &CUIButton::MouseOut);
    SAFE_RELEASE(pCol);
